...
const BalaceCard = ({balance,count,loading}:any) => {
    return (
        ...
        <span >
            <h5 className="mb-2 text-2xl font-semibold tracking-tight">₹ {loading ?<LiaSpinnerSolid className="loading-icon"/>:  <CountUp isCounting end={parseInt(balance)} duration={2} />}</h5>
        </span>
